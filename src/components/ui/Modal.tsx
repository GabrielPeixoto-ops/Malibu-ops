...
export default function Modal({ open, onClose, title, children }: ModalProps) {
  ...
  return (
    ...
    >
      <div className="bg-panel border border-wire rounded-xl shadow-2xl w-full max-w-lg max-h-[90vh] flex flex-col">
        <div className="flex items-center justify-between px-5 py-4 border-b border-wire">
          <h2 className="font-display font-semibold text-parchment tracking-wide">{title}</h2>
